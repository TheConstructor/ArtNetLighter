...
public class ArtPollReplyTest {
    ...
    public void testConstructFromBytes() throws Exception {
        final ArtPollReply artPollReply = new ArtPollReply(ArtPollReplyTest.captured_data1);
    ...
    public void testEquals() throws Exception {
        assertEquals(new ArtPollReply(ArtPollReplyTest.captured_data1), new ArtPollReply(ArtPollReplyTest.cleaned_data1));
    }
}
